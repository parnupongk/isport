<%@ Page Title="" Language="C#" MasterPageFile="~/admin/adminMaster.Master" AutoEventWireup="true" CodeBehind="adminfooter.aspx.cs" Inherits="isport.admin.adminfooter" %>
...
<table style="width: 100%;">
        ...
        <tr>
            <td align="center">
                &nbsp; &nbsp; Project Type(New) : &nbsp;<asp:TextBox ID="txtProjectType" runat="server"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>
    ...
    onrowcommand="gvContent_RowCommand" ClientInstanceName="gvContent" 
        KeyFieldName="footer_id" Width="100%">
...
<dxwgv:GridViewDataTextColumn Caption="index" VisibleIndex="3" FieldName="footer_index">
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn Caption="start date" FieldName="footer_startdate" 
                                    VisibleIndex="4">
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn Caption="end date" FieldName="footer_enddate" 
                                    VisibleIndex="5">
                                </dxwgv:GridViewDataTextColumn>
...
<dxwgv:GridViewDataTextColumn FieldName="content_image" Caption="image" VisibleIndex="7">
    <DataItemTemplate>
        ...
        <asp:Image ID="Image1" runat="server" ImageUrl='<%# CheckImagePath(Eval("content_image").ToString()) %>' />
                                ...
                                <dxwgv:GridViewDataTextColumn Caption="is payment" FieldName="footer_ispayment" 
                                    VisibleIndex="12">
                                </dxwgv:GridViewDataTextColumn>
                                
                                <dxwgv:GridViewDataTextColumn Caption="id" FieldName="footer_id" Visible="False" 
                                    VisibleIndex="12">
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn Caption="operator" FieldName="footer_operator" 
                                    VisibleIndex="13">
                                </dxwgv:GridViewDataTextColumn>
                                
                                <dxwgv:GridViewDataTextColumn Caption="is default" Name="footer_isdefault" FieldName="footer_isdefault"
                                    VisibleIndex="14">
                                </dxwgv:GridViewDataTextColumn>
