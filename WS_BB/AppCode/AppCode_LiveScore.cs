    ...
    public class AppCode_LiveScore : AppCode_Base
    {
        ...
        public string CommandGetScore_test(XDocument rtnXML, string countryId, string lang, string contestGroupId, MatchType matchType, decimal addDate, string isByWeek)
        {
            ...
            //{
                ...
                //    {
                //        // Get by country
                //        ds = SqlHelper.ExecuteDataset(strConnFeed, CommandType.StoredProcedure, "usp_sportcc_getfootballscorebycountryId_test"
                ...
                //                img16 = dv[index]["PIC_16X11"].ToString() == "" ? "default.png" : dv[index]["PIC_16X11"].ToString();
                ...
                //               , new XAttribute("minutes", dv[index]["curent_period"].ToString() == MatchType.Finished.ToString() ? "FT" : dv[index]["minutes"].ToString())
                ...
                //               , new XAttribute("matchDate", dv[index]["matchdate"].ToString())
                //               , new XAttribute("contestGroupId", dv[index]["contestgroupid"].ToString())
                //               , new XAttribute("isDetail", isDetail)
                //               ));
