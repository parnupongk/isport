...
namespace isport_foxhun
{
    ...
    public partial class isportEntities : DbContext
    {
        ...
        public virtual int usp_foxhun_teaminsert(string id, string region, Nullable<int> seq, Nullable<System.DateTime> create_datetime, Nullable<System.DateTime> update_date, string name, string detail, string email, string image, string username, string password, string contact, string contact1, string contact2, string phone, string phone1, string phone2, string file1, string file2, string file3, string file4, string file5, string file6, string file7, string file8, string file9, string file10)
        {
            var idParameter = id != null ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_foxhun_teaminsert", idParameter, regionParameter, seqParameter, create_datetimeParameter, update_dateParameter, nameParameter, detailParameter, emailParameter, imageParameter, usernameParameter, passwordParameter, contactParameter, contact1Parameter, contact2Parameter, phoneParameter, phone1Parameter, phone2Parameter, file1Parameter, file2Parameter, file3Parameter, file4Parameter, file5Parameter, file6Parameter, file7Parameter, file8Parameter, file9Parameter, file10Parameter);
        }
    
        public virtual ObjectResult<usp_foxhun_teamselectall_Result> usp_foxhun_teamselectall(string region_id)
        {
            var region_idParameter = region_id != null ?
                new ObjectParameter("region_id", region_id) :
                new ObjectParameter("region_id", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_foxhun_teamselectall_Result>("usp_foxhun_teamselectall", region_idParameter);
        }
