...
namespace isport_foxhun
{
    ...
    public partial class isportEntities : DbContext
    {
        public isportEntities()
            : base("name=isportEntities")
        {
        }
        ...
        public virtual int usp_foxhun_matchinsert(string id, Nullable<System.DateTime> createdate, Nullable<System.DateTime> updatedate, string matchdate, string team1, string team2, string ht, string ft, string field)
        {
            ...
            var matchdateParameter = matchdate != null ?
                new ObjectParameter("matchdate", matchdate) :
                new ObjectParameter("matchdate", typeof(string));
    
            var team1Parameter = team1 != null ?
                new ObjectParameter("team1", team1) :
                new ObjectParameter("team1", typeof(string));
    
            var team2Parameter = team2 != null ?
                new ObjectParameter("team2", team2) :
                new ObjectParameter("team2", typeof(string));
